...
/*
* This is a custom file we have added to handle processing of our e-puck packet protocol.
*
* The receive function is intended to be run in an agenda so that message can be asynchronously processed.
*
* You can also directly call the receive function in order to create a synchrounous message communication.
*
