...
/*
* Performs the love speed adaption once.
*/
void love()
{		
	// Iterator Variables
...
*
* Creates the "love" braitenberg behaviour.
*
* As the sensory values increase, the motors on the same side slow down, causing the look of attraction.
*
